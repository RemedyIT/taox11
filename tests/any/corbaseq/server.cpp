  ...
  try
    {
      ...
      if (!root_poa)
      {
        TAOX11_TEST_ERROR << "ERROR: PortableServer::POA::narrow (obj) returned null object." << std::endl;
        return 1;
      }
      ...
      CORBA::servant_traits<Test::Hello>::ref_type hello_impl = CORBA::make_reference<Hello> (_orb);
