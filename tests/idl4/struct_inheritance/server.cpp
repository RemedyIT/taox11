  ...
  try
    {
      ...
      CORBA::servant_traits<Foo>::ref_type foo_impl = CORBA::make_reference<FooImpl> (_orb, root_poa);
      ...
      IDL::traits<Foo>::ref_type foo = IDL::traits<Foo>::narrow (foo_obj);

      if (foo == nullptr)
      {
        TAOX11_TEST_ERROR << "ERROR: IDL::traits<Foo>::narrow (foo_obj) returned null reference." << std::endl;
        return 1;
      }
