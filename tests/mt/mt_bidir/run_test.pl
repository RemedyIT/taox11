...
$client_status = $CL1->WaitKill ($client1->ProcessStopWaitInterval() + 90);
...
$client_status = $CL2->WaitKill ($client2->ProcessStopWaitInterval() + 90);
...
$client_status = $CL3->WaitKill ($client3->ProcessStopWaitInterval() + 90);
