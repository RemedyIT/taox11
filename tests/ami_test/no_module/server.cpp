...
main(int argc, ACE_TCHAR *argv[])
{
  ...
  try
  {
    ...
    CORBA::servant_traits<Hello>::ref_type hello_impl =
      CORBA::make_reference<Hello_i> (_orb, root_poa);
    ...
    {
      TAOX11_TEST_ERROR
        << "ERROR: IDL::traits<Hello>::narrow (hello_obj) returned null reference."
        << std::endl;
      return 1;
    }
    ...
    TAOX11_TEST_INFO << "IOR for Hello servant written to 'server.ior' : "
                << ior << std::endl;
