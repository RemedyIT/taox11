  ...
  try
    {
      ...
      CORBA::servant_traits<A::Hello>::ref_type hello_impl =
      ...
      IDL::traits<A::Hello>::ref_type hello =
          IDL::traits<A::Hello>::narrow (hello_obj);

      if (hello == nullptr)
        {
          TAOX11_TEST_ERROR
            << "ERROR: IDL::traits<A::Hello>::narrow (hello_obj) returned null reference."
            << std::endl;
          return 1;
        }
      ...
      TAOX11_TEST_INFO << "IOR for Hello servant written to 'server.ior' : " << std::endl;
