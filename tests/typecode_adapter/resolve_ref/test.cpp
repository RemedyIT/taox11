...
int main( int argc, char* argv[] )
{
  ...
  try
  {
    ...
    TAOX11_TEST_INFO << "going to test  creating typecodes with the TypCodeFactory..." << std::endl;

    IDL::traits<CORBA::Object>::ref_type obj =
       _orb->resolve_initial_references ("TypeCodeFactory");

    if (obj == nullptr)
    {
      TAOX11_TEST_ERROR << "ERROR: Unable to resolve_initial_references :'TypeCodeFactory'."
                        << std::endl;
       return 1;
    }

    IDL::traits<CORBA::TypeCodeFactory>::ref_type typecode_factory =
       IDL::traits<CORBA::TypeCodeFactory>::narrow (obj);

    if (typecode_factory == nullptr)
    {
      TAOX11_TEST_ERROR << "ERROR: Unable to retrieve the TypeCodeFactory."
                        << std::endl;
       return 1;
    }
    ...
    CORBA::object_reference<CORBA::TypeCode> string_tc =
        typecode_factory->create_string_tc (bound);
    ...
    CORBA::object_reference<CORBA::TypeCode> wstring_tc =
          typecode_factory->create_wstring_tc (bound);
    ...
    CORBA::object_reference<CORBA::TypeCode> fixed_tc =
            typecode_factory->create_fixed_tc (10, 11);
    ...
    CORBA::object_reference<CORBA::TypeCode> alias_string_tc =
        typecode_factory->create_alias_tc ("IDL:foo:1.0","foo",string_tc);
    ...
    CORBA::object_reference<CORBA::TypeCode> interface_tc =
        typecode_factory->create_interface_tc ("IDL:foo:1.7","foo_interface");
    ...
    try {
      ...
      CORBA::object_reference<CORBA::TypeCode> interface_tc_excep =
        typecode_factory->create_interface_tc ("lala","foo");
    ...
    CORBA::object_reference<CORBA::TypeCode> abstract_interface_tc =
         typecode_factory->create_abstract_interface_tc ("IDL:foo:1.0","foo");
    ...
    CORBA::object_reference<CORBA::TypeCode> local_interface_tc =
             typecode_factory->create_local_interface_tc ("IDL:foo:1.0","foo");
    ...
    CORBA::object_reference<CORBA::TypeCode> component_tc =
             typecode_factory->create_component_tc ("IDL:bar:1.0","foo_comp");
    ...
    CORBA::object_reference<CORBA::TypeCode> home_tc =
             typecode_factory->create_home_tc ("IDL:foo:1.0","foo");
    ...
    CORBA::object_reference<CORBA::TypeCode> struct_tc =
         typecode_factory->create_struct_tc ("IDL:lala:1.0", "MyStruct", struct_members);
    ...
    try
    {
      CORBA::object_reference<CORBA::TypeCode> struct_tc_except =
         typecode_factory->create_struct_tc ("IDL:lala:1.0", "MyStruct", struct_members_except);
    }
    ...
    CORBA::object_reference<CORBA::TypeCode> exception_tc =
         typecode_factory->create_exception_tc ("IDL:lala:1.0", "MyException", exception_members);
    ...
    CORBA::object_reference<CORBA::TypeCode> union_tc =
            typecode_factory->create_union_tc ("IDL:foo:1.0",
                                   "foo",
                                   CORBA::_tc_short,
                                   union_members);
    ...
    CORBA::object_reference<CORBA::TypeCode> enum_tc =
             typecode_factory->create_enum_tc ("IDL:foo_enum:1.0",
                                   "foo_enum",
                                   eseq);
    ...
    CORBA::object_reference<CORBA::TypeCode> seq_tc =
                 typecode_factory->create_sequence_tc (3, CORBA::_tc_short);
    ...
    CORBA::object_reference<CORBA::TypeCode> array_tc =
                 typecode_factory->create_array_tc (4, CORBA::_tc_long);
    ...
    CORBA::object_reference<CORBA::TypeCode> recursive_tc =  typecode_factory->create_recursive_tc ("IDL:foo:1.0");
    ...
    CORBA::object_reference<CORBA::TypeCode> value_tc =
        typecode_factory->create_value_tc ("IDL:foo:1.0", "MyValue", CORBA::VM_CUSTOM, CORBA::_tc_null, value_members);
    ...
    CORBA::object_reference<CORBA::TypeCode> value_box_tc =
                 typecode_factory->create_value_box_tc ("IDL:foo:1.1","valuebox", CORBA::_tc_long);
    ...
    CORBA::object_reference<CORBA::TypeCode> native_tc =
                typecode_factory->create_native_tc ("IDL:foo:1.1","native");
    ...
    CORBA::object_reference<CORBA::TypeCode> event_tc =
        typecode_factory->create_event_tc ("IDL:foo:2.0", "MyEvent", CORBA::VM_NONE, CORBA::_tc_null, event_members);
