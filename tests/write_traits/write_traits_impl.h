/**
 * @file    write_traits_impl.h
 * @author  Unknown
 * @brief   Servant implementations
 *
 * Generated by 'brix11 generate servant' @ 2014-03-02 15:41:45 +0100
 *
 * @copyright Copyright (c) Remedy IT Expertise BV
 */
//@@{__RIDL_REGEN_MARKER__} - HEADER_END : write_traits_impl.h[Header]

#ifndef __RIDL_WRITE_TRAITS_IMPL_H_INCLUDED__
#define __RIDL_WRITE_TRAITS_IMPL_H_INCLUDED__

#pragma once

#include "write_traitsS.h"
#include "tao/x11/orb.h"

//@@{__RIDL_REGEN_MARKER__} - BEGIN : write_traits_impl.h[User Includes]
// your includes here
//@@{__RIDL_REGEN_MARKER__} - END : write_traits_impl.h[User Includes]
...
#endif /* __RIDL_WRITE_TRAITS_IMPL_H_INCLUDED__ */
//@@{__RIDL_REGEN_MARKER__} - BEGIN : write_traits_impl.h[Footer]
// Your footer here.
// -*- END -*-
