 ...
 */
//@@{__RIDL_REGEN_MARKER__} - HEADER_END : write_traits_impl.cpp[Header]

#include "write_traits_impl.h"
#include "testlib/taox11_testlog.h"

//@@{__RIDL_REGEN_MARKER__} - BEGIN : write_traits_impl.cpp[User Includes]
// your includes here
//@@{__RIDL_REGEN_MARKER__} - END : write_traits_impl.cpp[User Includes]
...
//@@{__RIDL_REGEN_MARKER__} - BEGIN : write_traits_impl.cpp[Footer]
// Your footer here.
// -*- END -*-
