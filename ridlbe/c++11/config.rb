      ...
      ol.for_switch '-G{generation options}', type: String, separator: true do |swcfg|
        ...
        swcfg.define_group :gen_flags, params: {
              ...
              'xhcp' => { option_name: :gen_export_client_proxy,
                       description: "-Gxhpr\t\t\tGenerate export header file for client proxy (not generated by default)" },
              'xhat' => { option_name: :gen_export_anytypecode,
                       description: "-Gxhpr\t\t\tGenerate export header file for Any and TypeCode support (not generated by default)" },
