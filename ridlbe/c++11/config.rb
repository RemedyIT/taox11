  ...
  module Cxx11
    ...
    def self.add_extended_options(ol, _idl_params)
      ...
      ol.for_switch '-S{suppression options}', type: String, separator: true do |swcfg|
        ...
        swcfg.modify_group :suppress_flags do |grpcfg|
          grpcfg.for_param 'corba',
                           :description => "-Scorba\t\t\tSuppress any CORBA related code generation (implies -Sa/-St/-Scdr/-Sorb/-SS/-Ssh/-Scp)" do |arg, params|
            params[:no_corba] = true
            params[:no_servant_code] = true
            params[:no_servant_header] = true
            params[:no_orb_include] = true
            params[:no_client_proxy] = true
