      ...
      ol.for_switch '-S{suppression options}', :type => String, :separator => true do |swcfg|
        swcfg.define_group :suppress_flags, :params => {
              'na' => { :option_name => :no_gen_native,
                       :description => "-Sna\t\t\tSuppress native types (generated by default)" },
              'S' => { :option_name => :no_servant_code,
                       :description => "-SS\t\t\tSuppress skeleton implementation and inline file (generated by default)" },
              'sh' => { :option_name => :no_servant_header,
                       :description => "-Ssh\t\t\tSuppress skeleton header file (generated by default)" },
              'orb' => { :option_name => :no_orb_include,
                       :description => "-Sorb\t\t\tSuppress include of orb.h (generated by default)" },
              'ots' => { :option_name => :no_object_traits,
                       :description => "-Sots\t\t\tSuppress interface traits specializations (generated by default)" },
              'cc' => { :option_name => :no_client_source,
                       :description => "-Scc\t\t\tSuppress client source file (generated by default)" },
              'ch' => { :option_name => :no_client_header,
                       :description => "-Sch\t\t\tSuppress client header file (generated by default)" },
              'cp' => { :option_name => :no_client_proxy,
                       :description => "-Scp\t\t\tSuppress client proxy header file (generated by default)" },
              'cdr' => { :option_name => :no_cdr_streaming,
                       :description => "-Scdr\t\t\tSuppress CDR streaming operators (generated by default)" },
            }
        swcfg.define_group :suppress_flags_false, :params => {
              ...
              'p' => { :option_name => :gen_thru_poa_collocation, :value => false,
                       :description => "-Sp\t\t\tSuppress through POA collocated stubs (generated by default)" },
        ...
        swcfg.define_group :noop, :params => {
              'ci' => { :type => :noop,
                       :description => "-Sci\t\t\tSuppress client inline file (always suppressed)" },
              'si' => { :type => :noop,
                       :description => "-Ssi\t\t\tSuppress skeleton inline file (always suppressed)" },
            }
      end
