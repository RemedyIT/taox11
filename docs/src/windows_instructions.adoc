...
Currently for development on the Windows platform
the MinGW-w64 toolchain (a GNU compiler toolchain variant for the
Windows platform), Visual Studio 2015 Update 2 or newer,
Visual Studio 2017 Update 3 or newer, and Intel C++ 2016 are supported.
...
1.  Perl implementation for Windows
2.  Ruby implementation for Windows

For a development environment using MinGW-w64 also the following software
has to be installed

1.  Collection of build tools supporting GNU make based development
2.  MinGW-w64 toolchain for the targeted environment (i686 or x86_64)
...
available for download through their open source portal website
https://osportal.remedy.nl[OSPortal].
