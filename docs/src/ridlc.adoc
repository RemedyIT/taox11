...
Suppress native types (generated by default)|

off

||-SS|

Suppress skeleton implementation and inline file (generated by default)|

off

||-Ssh|

Suppress skeleton header file (generated by default)|

off

||-Sorb|

Suppress generating include of orb.h
...
Suppress interface traits specializations (generated by default)|

off

||-Scc|

Suppress client source file (generated by default)|

off

||-Sch|

Suppress client header file (generated by default)|

off

||-Scp|

Suppress client proxy header file (generated by default)|

off

||-Scdr|

Suppress CDR streaming operators (generated by default)|

off

||-Sa|

Suppress Any support (generated by default)|
...
Suppress through POA collocated stubs (generated by default)|

off

||-St|

Suppress TypeCode support (generated by default)|

off

||-Sci|

Suppress client inline file (always suppressed)|

off

||-Ssi|

Suppress skeleton inline file (always suppressed)|
