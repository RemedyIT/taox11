...
https://taox11.remedy.nl/documents/presentations.html[TAOX11] website for
more details.
...
counting requirements. +
 As you can see in the https://taox11.remedy.nl/documents/presentations.html[IDL2C++11
...
On the Remedy IT https://taox11.remedy.nl/documents/presentations.html[TAOX11]
product website you can find the
...
TAOX11 is currently supported using the following compilers
...
TAOX11 is currently supported on
...
For the prerequisites, installation, and usage of TAOX11 on Android read our
<<taox11_on_android.adoc#,Android>> instructions.
...
<<{parent_dir}/brix11/brix11.adoc#,BRIX11>> is a toolset provided by Remedy
IT to help you start up your TAOX11 development and to simplify building
...
`perl $ACE_ROOT/bin/auto_run_tests.pl -r $TAOX11_BASE_ROOT -l $TAOX11_BASE_ROOT/bin/taox11_tests.lst`
to run the tests.
...
For Visual Studio 2015 invoke
`perl %TAOX11_ROOT%/bin/mwc.pl -type vc14` and for Visual Studio 2017
invoke `perl %TAOX11_ROOT%/bin/mwc.pl -type vs2017`.
This will create the Visual Studio solutions. MPC will iterate through all sub
...
TAOX11 and BRIX11 are supported by Remedy IT. Please read the
<<taox11_faq.adoc#,FAQ-section>> first before asking a
question. +
 If your problem was not listed in the FAQ, you can submit your issue
online through our https://swsupport.remedy.nl[Software Support Portal]
or by sending an email with a detailed description using our
PROBLEM-REPORT-FORM to
mailto:taox11support@remedy.nl[taox11support@remedy.nl]. The
PROBLEM-REPORT-FORM is available in the root directory of the TAOX11
package, please follow the directions in the PRF.

=== Training material

A basic tutorial about the IDL to {cxx11} language mapping is available at
the Remedy IT
https://taox11.remedy.nl/documents/presentations.html[TAOX11 product website]. There
you can also find a comparison between the IDL to C++ and IDL to {cxx11}
language mapping. +
 +
 Remedy IT offers a
https://taox11.remedy.nl/services/training.html[CORBA
