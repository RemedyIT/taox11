...
#if defined (TAOX11_AS_STATIC_LIBS) && !defined (TAOX11_PORTABLESERVER_HAS_DLL)
#  define TAOX11_PORTABLESERVER_HAS_DLL 0
#endif /* TAOX11_AS_STATIC_LIBS && TAOX11_PORTABLESERVER_HAS_DLL */
...
#    define TAOX11_PortableServer_Export TAOX11_Proper_Export_Flag
#    define TAOX11_PORTABLESERVER_SINGLETON_DECLARATION(T) TAOX11_EXPORT_SINGLETON_DECLARATION (T)
#    define TAOX11_PORTABLESERVER_SINGLETON_DECLARE(SINGLETON_TYPE, CLASS, LOCK) TAOX11_EXPORT_SINGLETON_DECLARE(SINGLETON_TYPE, CLASS, LOCK)
#  else /* TAOX11_PORTABLESERVER_BUILD_DLL */
#    define TAOX11_PortableServer_Export TAOX11_Proper_Import_Flag
#    define TAOX11_PORTABLESERVER_SINGLETON_DECLARATION(T) TAOX11_IMPORT_SINGLETON_DECLARATION (T)
#    define TAOX11_PORTABLESERVER_SINGLETON_DECLARE(SINGLETON_TYPE, CLASS, LOCK) TAOX11_IMPORT_SINGLETON_DECLARE(SINGLETON_TYPE, CLASS, LOCK)
