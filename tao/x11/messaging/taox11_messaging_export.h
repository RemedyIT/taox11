...
#if defined (ACE_AS_STATIC_LIBS) && !defined (TAOX11_MESSAGING_HAS_DLL)
#  define TAOX11_MESSAGING_HAS_DLL 0
#endif /* ACE_AS_STATIC_LIBS && TAOX11_MESSAGING_HAS_DLL */
...
#    define TAOX11_MESSAGING_Export ACE_Proper_Export_Flag
#    define TAOX11_MESSAGING_SINGLETON_DECLARATION(T) ACE_EXPORT_SINGLETON_DECLARATION (T)
#    define TAOX11_MESSAGING_SINGLETON_DECLARE(SINGLETON_TYPE, CLASS, LOCK) ACE_EXPORT_SINGLETON_DECLARE(SINGLETON_TYPE, CLASS, LOCK)
#  else /* TAOX11_MESSAGING_BUILD_DLL */
#    define TAOX11_MESSAGING_Export ACE_Proper_Import_Flag
#    define TAOX11_MESSAGING_SINGLETON_DECLARATION(T) ACE_IMPORT_SINGLETON_DECLARATION (T)
#    define TAOX11_MESSAGING_SINGLETON_DECLARE(SINGLETON_TYPE, CLASS, LOCK) ACE_IMPORT_SINGLETON_DECLARE(SINGLETON_TYPE, CLASS, LOCK)
