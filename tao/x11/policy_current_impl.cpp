...
namespace TAOX11_NAMESPACE
{
  namespace CORBA
  {
    ...
    public:
      ...
      ~Policy_Current_impl () override = default;
    ...
    private:
      Policy_Current_impl (const Policy_Current_impl&) = delete;
      Policy_Current_impl (Policy_Current_impl&&) = delete;
      Policy_Current_impl& operator= (const Policy_Current_impl&) = delete;
      Policy_Current_impl& operator= (Policy_Current_impl&&) = delete;

      TAO_CORBA::PolicyCurrent_ptr pol_;
    };

    Policy_Current_impl::Policy_Current_impl (TAO_CORBA::PolicyCurrent_ptr polptr)
      : pol_ (polptr)
    {
    ...
    ::TAOX11_NAMESPACE::CORBA::PolicyList
    Policy_Current_impl::get_policy_overrides (
      const ::TAOX11_NAMESPACE::CORBA::PolicyTypeSeq& ts)
    {
      try
      {
        ...
        TAO_CORBA::PolicyList_var _list_tmp = this->pol_->get_policy_overrides (
                            _type_seq_tmp);
    ...
    void
    Policy_Current_impl::set_policy_overrides (
      const ::TAOX11_NAMESPACE::CORBA::PolicyList& policies,
      ::TAOX11_NAMESPACE::CORBA::SetOverrideType set_add)
    {
      try
      {
        ...
        {
          _pols[n++] =
            TAO_CORBA::Policy::_narrow (
              const_cast <TAO_CORBA::Object_ptr>(_pol->get_proxy ()->get ()));
        }
        this->pol_->set_policy_overrides (
                            _pols,
    ...
    template<>
    object_traits< ::TAOX11_NAMESPACE::CORBA::PolicyCurrent>::ref_type
    object_traits< ::TAOX11_NAMESPACE::CORBA::PolicyCurrent>::narrow (
       object_traits<TAOX11_NAMESPACE::CORBA::Object>::ref_type objref)
    {
      if (objref)
      {
        ...
        try
        {
          TAO_CORBA::PolicyCurrent_ptr polptr =
              TAO_CORBA::PolicyCurrent::_narrow (objref->get_proxy ()->get ());
          if (!TAO_CORBA::is_nil (polptr))
          {
            return CORBA::make_reference<Policy_Current_impl> (polptr);
          }
        }
