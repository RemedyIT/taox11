...
#undef TAOX11_SYSTEM_EXCEPTION
    ...
    void insert_into_any (CORBA::Any * any, IDL::traits<CORBA::Object>::ref_type object) override;

    void insert_into_any (CORBA::Any * any, IDL::traits<CORBA::Policy>::ref_type policy) override;

    void insert_into_any (CORBA::Any * any, uint32_t value) override;

    void insert_into_any (CORBA::Any * any, int32_t value) override;

    void insert_into_any (CORBA::Any * any, int16_t value) override;

    void insert_into_any (CORBA::Any * any, uint16_t value) override;

    void insert_into_any (CORBA::Any * any, float value) override;

    void insert_into_any (CORBA::Any * any, double value) override;

    void insert_into_any (CORBA::Any * any, int64_t value) override;

    void insert_into_any (CORBA::Any * any, uint64_t value) override;

    void insert_into_any (CORBA::Any * any, long double value) override;

    void insert_into_any (CORBA::Any * any, wchar_t value) override;

    void insert_into_any (CORBA::Any * any, char value) override;

    void insert_into_any (CORBA::Any * any, uint8_t value) override;

    void insert_into_any (CORBA::Any * any, bool value) override;
    ...
    void x11_any_to_tao_any (const CORBA::Any*, TAO_CORBA::Any*) override;

    CORBA::Any* allocate_any (void) override;

    void deallocate_any (CORBA::Any * any) override;
