 ...
 *
 * This file is generated automatically by generate_export_file.pl TAOX11_IORTable
 *
...
#if defined (ACE_AS_STATIC_LIBS) && !defined (TAOX11_IOR_TABLE_HAS_DLL)
#  define TAOX11_IOR_TABLE_HAS_DLL 0
#endif /* ACE_AS_STATIC_LIBS && TAOX11_IOR_TABLE_HAS_DLL */
...
#    define TAOX11_IORTable_Export ACE_Proper_Export_Flag
#    define TAOX11_IOR_TABLE_SINGLETON_DECLARATION(T) ACE_EXPORT_SINGLETON_DECLARATION (T)
#    define TAOX11_IOR_TABLE_SINGLETON_DECLARE(SINGLETON_TYPE, CLASS, LOCK) ACE_EXPORT_SINGLETON_DECLARE(SINGLETON_TYPE, CLASS, LOCK)
#  else /* TAOX11_IOR_TABLE_BUILD_DLL */
#    define TAOX11_IORTable_Export ACE_Proper_Import_Flag
#    define TAOX11_IOR_TABLE_SINGLETON_DECLARATION(T) ACE_IMPORT_SINGLETON_DECLARATION (T)
#    define TAOX11_IOR_TABLE_SINGLETON_DECLARE(SINGLETON_TYPE, CLASS, LOCK) ACE_IMPORT_SINGLETON_DECLARE(SINGLETON_TYPE, CLASS, LOCK)
